...
const Header = () => {
  return (
    <div className='container flex justify-between mx-auto min-w-full pt-0.5 pb-0.5 bg-gray-100'>
      <div className='appLogo flex content-center'>
        ...
        <div className='mt-2 w-2 h-6 border-2 border-b-gray-900 border-t-red-700 border-l-yellow-600 border-r-green-600 rounded-full animate-spin'></div>
      </div>
